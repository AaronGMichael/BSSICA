...
def two_channelip():
    sampling_rate, mix1 = wavfile.read('Resources/mix1.wav')
    sampling_rate, mix2 = wavfile.read('Resources/mix2.wav')
    sampling_rate, source1 = wavfile.read('Resources/source1.wav')
    sampling_rate, source2 = wavfile.read('Resources/source2.wav')
